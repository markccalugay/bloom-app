...
final bloomLightTheme = ThemeData(
  ...
  colorScheme: ColorScheme(
    ...
    tertiary: BloomLightColors.success,
    onTertiary: BloomLightColors.textPrimary,
    tertiaryContainer: BloomLightColors.highlight,
    onTertiaryContainer: BloomLightColors.textPrimary,
  ),
...
final bloomDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme(
    ...
    tertiary: BloomDarkColors.success,
    onTertiary: Colors.white,
    tertiaryContainer: BloomDarkColors.accent,
