...
const focusAffirmations = <Affirmation>[
  Affirmation(id: 'focus_001', packId: AffirmationPackIds.focus, text: 'I focus on one task right now.'),
  Affirmation(id: 'focus_002', packId: AffirmationPackIds.focus, text: 'I begin even before I feel ready.'),
  Affirmation(id: 'focus_003', packId: AffirmationPackIds.focus, text: 'I grow focus when I remove urgency.'),
  Affirmation(id: 'focus_004', packId: AffirmationPackIds.focus, text: 'I don’t need momentum to start.'),
  Affirmation(id: 'focus_005', packId: AffirmationPackIds.focus, text: 'My small progress still counts.'),
  Affirmation(id: 'focus_006', packId: AffirmationPackIds.focus, text: 'I work calmly and stay effective.'),
  Affirmation(id: 'focus_007', packId: AffirmationPackIds.focus, text: 'I choose where my attention goes.'),
  Affirmation(id: 'focus_008', packId: AffirmationPackIds.focus, text: 'I return to the task without judgment.'),
  Affirmation(id: 'focus_009', packId: AffirmationPackIds.focus, text: 'I find clarity by doing, not overthinking.'),
  Affirmation(id: 'focus_010', packId: AffirmationPackIds.focus, text: 'I finish this one step at a time.'),
  Affirmation(id: 'focus_011', packId: AffirmationPackIds.focus, text: 'I feel discomfort without treating it as danger.'),
  Affirmation(id: 'focus_012', packId: AffirmationPackIds.focus, text: 'I begin without perfect conditions.'),
  Affirmation(id: 'focus_013', packId: AffirmationPackIds.focus, text: 'I slow down and still move forward.'),
  Affirmation(id: 'focus_014', packId: AffirmationPackIds.focus, text: 'I build focus instead of forcing it.'),
  Affirmation(id: 'focus_015', packId: AffirmationPackIds.focus, text: 'I allow myself to work without pressure.'),
  Affirmation(id: 'focus_016', packId: AffirmationPackIds.focus, text: 'I take one clear action right now.'),
  Affirmation(id: 'focus_017', packId: AffirmationPackIds.focus, text: 'I release distraction and return gently.'),
  Affirmation(id: 'focus_018', packId: AffirmationPackIds.focus, text: 'I choose progress over intensity.'),
  Affirmation(id: 'focus_019', packId: AffirmationPackIds.focus, text: 'I stay with this moment.'),
  Affirmation(id: 'focus_020', packId: AffirmationPackIds.focus, text: 'I create better results with calm attention.'),
  Affirmation(id: 'focus_021', packId: AffirmationPackIds.focus, text: 'I don’t rush to be productive.'),
  Affirmation(id: 'focus_022', packId: AffirmationPackIds.focus, text: 'I steady my breath and sharpen my work.'),
  Affirmation(id: 'focus_023', packId: AffirmationPackIds.focus, text: 'I reset my focus at any time.'),
  Affirmation(id: 'focus_024', packId: AffirmationPackIds.focus, text: 'My work does not define my worth.'),
  Affirmation(id: 'focus_025', packId: AffirmationPackIds.focus, text: 'I finish what I can, and it’s enough.'),
];

/// Sleep & Night Reset affirmations (25)
const sleepAffirmations = <Affirmation>[
  Affirmation(id: 'sleep_001', packId: AffirmationPackIds.sleep, text: 'I let the day end here.'),
  Affirmation(id: 'sleep_002', packId: AffirmationPackIds.sleep, text: 'I don’t need to solve everything tonight.'),
  Affirmation(id: 'sleep_003', packId: AffirmationPackIds.sleep, text: 'I rest to support tomorrow.'),
  ...
  Affirmation(id: 'sleep_007', packId: AffirmationPackIds.sleep, text: 'I let my thoughts slow naturally.'),
  Affirmation(id: 'sleep_008', packId: AffirmationPackIds.sleep, text: 'I let tomorrow wait until morning.'),
  Affirmation(id: 'sleep_009', packId: AffirmationPackIds.sleep, text: 'I stop holding everything.'),
  Affirmation(id: 'sleep_010', packId: AffirmationPackIds.sleep, text: 'I let sleep come without forcing it.'),
  Affirmation(id: 'sleep_011', packId: AffirmationPackIds.sleep, text: 'I signal safety with every steady breath.'),
  Affirmation(id: 'sleep_012', packId: AffirmationPackIds.sleep, text: 'I soften without losing control.'),
  Affirmation(id: 'sleep_013', packId: AffirmationPackIds.sleep, text: 'I treat the night as a reset.'),
  Affirmation(id: 'sleep_014', packId: AffirmationPackIds.sleep, text: 'I don’t need answers to rest.'),
  Affirmation(id: 'sleep_015', packId: AffirmationPackIds.sleep, text: 'I allow my nervous system to calm.'),
  Affirmation(id: 'sleep_016', packId: AffirmationPackIds.sleep, text: 'I let this moment be quiet.'),
  Affirmation(id: 'sleep_017', packId: AffirmationPackIds.sleep, text: 'I trust my body to rest when it’s ready.'),
  Affirmation(id: 'sleep_018', packId: AffirmationPackIds.sleep, text: 'My work today is complete enough.'),
  Affirmation(id: 'sleep_019', packId: AffirmationPackIds.sleep, text: 'I put the day down now.'),
  Affirmation(id: 'sleep_020', packId: AffirmationPackIds.sleep, text: 'I let calm arrive by releasing resistance.'),
  Affirmation(id: 'sleep_021', packId: AffirmationPackIds.sleep, text: 'I don’t carry tomorrow tonight.'),
  Affirmation(id: 'sleep_022', packId: AffirmationPackIds.sleep, text: 'I let rest repair what effort can’t.'),
  Affirmation(id: 'sleep_023', packId: AffirmationPackIds.sleep, text: 'I am safe to slow all the way down.'),
  Affirmation(id: 'sleep_024', packId: AffirmationPackIds.sleep, text: 'I prepare for sleep with a steady breath.'),
...
const strengthAffirmations = <Affirmation>[
  Affirmation(id: 'strength_001', packId: AffirmationPackIds.strength, text: 'I carry calm as a form of strength.'),
  Affirmation(id: 'strength_002', packId: AffirmationPackIds.strength, text: 'I can handle what’s in front of me.'),
  Affirmation(id: 'strength_003', packId: AffirmationPackIds.strength, text: 'I stay powerful without reacting.'),
  Affirmation(id: 'strength_004', packId: AffirmationPackIds.strength, text: 'I choose steady over aggressive.'),
  Affirmation(id: 'strength_005', packId: AffirmationPackIds.strength, text: 'I trust myself to respond well.'),
  Affirmation(id: 'strength_006', packId: AffirmationPackIds.strength, text: 'I stay grounded under pressure.'),
  Affirmation(id: 'strength_007', packId: AffirmationPackIds.strength, text: 'I hold strength without tension.'),
  ...
  Affirmation(id: 'strength_011', packId: AffirmationPackIds.strength, text: 'I build confidence by staying present.'),
  Affirmation(id: 'strength_012', packId: AffirmationPackIds.strength, text: 'I move at my own pace.'),
  Affirmation(id: 'strength_013', packId: AffirmationPackIds.strength, text: 'I keep my power when I stay calm.'),
  Affirmation(id: 'strength_014', packId: AffirmationPackIds.strength, text: 'I choose clarity over impulse.'),
  Affirmation(id: 'strength_015', packId: AffirmationPackIds.strength, text: 'I am firm without being harsh.'),
  ...
  Affirmation(id: 'strength_018', packId: AffirmationPackIds.strength, text: 'I stay steady when things are uncertain.'),
  Affirmation(id: 'strength_019', packId: AffirmationPackIds.strength, text: 'I lead myself through this moment.'),
  Affirmation(id: 'strength_020', packId: AffirmationPackIds.strength, text: 'I let my strength be quiet.'),
