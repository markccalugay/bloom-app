...
class BloomStreakLocalStore {
  BloomStreakLocalStore(this._prefs);

  final SharedPreferences _prefs;

  static const String _kStreakCountKey = 'bloom_streak_count';
  static const String _kLastDateKey = 'bloom_streak_last_date'; // yyyy-MM-dd
  static const String _kTotalSessionsKey = 'bloom_total_sessions';
  static const String _kTotalSecondsKey = 'bloom_total_seconds';
  static const String _kSessionDatesKey = 'bloom_session_dates';
  static const String _kPracticeUsageKey = 'bloom_practice_usage';
...
// final local = BloomStreakLocalStore(prefs);