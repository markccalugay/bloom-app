...
class BloomThemeSelectionSheet extends StatelessWidget {
  const BloomThemeSelectionSheet({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            ...ThemeVariant.values.map((v) {
              ...
              final primaryColor = BloomTheme.getPrimaryColor(v);
              final bgColor = BloomTheme.getBackgroundColor(v);
