...
class BloomDebugDock extends StatefulWidget {
  final Widget child;

  const BloomDebugDock({super.key, required this.child});

  @override
  State<BloomDebugDock> createState() => _BloomDebugDockState();
}

class _BloomDebugDockState extends State<BloomDebugDock> {
  bool _isOpen = false;
  ...
  Widget _buildLogsTab() {
    return ListenableBuilder(
      listenable: BloomLogger.instance,
      builder: (context, _) {
        final logs = BloomLogger.instance.logs;
        return Container(
          decoration: BoxDecoration(
            color: Colors.black.withValues(alpha: 0.3),
  ...
  Widget _buildActionsTab() {
    return ListenableBuilder(
      listenable: BloomDebugActions.instance,
      builder: (context, _) {
        final actions = BloomDebugActions.instance.allActions;
        return ListView(
          children: [
            const Padding(
