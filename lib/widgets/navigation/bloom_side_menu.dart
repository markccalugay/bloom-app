...
Future<String> _getVersionLabel() async {
  ...
  return 'Bloom v${info.version} (build ${info.buildNumber})';
}
class BloomSideMenu extends StatelessWidget {
                    ...
                    ValueListenableBuilder<bool>(
                      ...
                      builder: (context, isPremium, _) {
                        return Padding(
                          ...
                          child: Text(
                            isPremium
                                ? 'Bloom+ Premium active'
                                : 'Bloom+ Premium available',
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<String>(
                        ...
                        builder: (context, snapshot) {
                          final label = snapshot.data ?? 'Bloom';
                          return Text(
                            label,
                            style: textTheme.bodySmall?.copyWith(
                              color: baseTextColor.withValues(alpha: 0.4),
