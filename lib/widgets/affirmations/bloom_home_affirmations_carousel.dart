...
class BloomHomeAffirmationsCarousel extends StatefulWidget {
  final int streak;

  const BloomHomeAffirmationsCarousel({
    super.key,
    required this.streak,
  });

  @override
  State<BloomHomeAffirmationsCarousel> createState() =>
      _BloomHomeAffirmationsCarouselState();
}

class _BloomHomeAffirmationsCarouselState
    extends State<BloomHomeAffirmationsCarousel> {
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: BloomHomeAffirmationsCard(
                  title: card.affirmation.text,
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => BloomAffirmationFullscreenScreen(
