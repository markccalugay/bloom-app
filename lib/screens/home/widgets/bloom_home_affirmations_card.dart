...
class BloomHomeAffirmationsCard extends StatelessWidget {
  ...
  const BloomHomeAffirmationsCard({
    super.key,
    required this.title,
    this.unlockedLabel,
    this.onTap,
...
class BloomAffirmationFullscreenScreen extends StatelessWidget {
  final String text;
  final String? unlockedLabel;

  const BloomAffirmationFullscreenScreen({
    super.key,
    required this.text,
    this.unlockedLabel,
  });
