...
import '../painters/bloom_breath_wave_painter.dart';
import '../painters/bloom_breath_ring_painter.dart';
import '../bloom_breath_constants.dart';

class BloomBreathCircle extends StatelessWidget {
  final BloomBreathController controller;
  const BloomBreathCircle({super.key, required this.controller});
          ...
          child: Stack(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CustomPaint(
                  painter: BloomBreathWavePainter(
