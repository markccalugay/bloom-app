...
import 'package:bloom_app/core/services/bloom_analytics.dart';
import 'package:url_launcher/url_launcher.dart';

class BloomPaywallScreen extends StatefulWidget {
  const BloomPaywallScreen({super.key});

  @override
  State<BloomPaywallScreen> createState() => _BloomPaywallScreenState();
}

class _BloomPaywallScreenState extends State<BloomPaywallScreen> {
  bool _isProcessing = false;
  String _selectedProductId = 'bloom.premium.yearly';
  ...
  Widget _buildPricingFlow(BuildContext context) {
    ...
    final isYearly = _selectedProductId == 'bloom.premium.yearly';
    ...
    return Column(
      ...
      children: [
        ...
        // Pricing Cards
        _PricingCard(
          productId: 'bloom.premium.yearly',
          title: 'Annual',
          priceDisplay: '\$49.99',
          intervalLabel: '/ year',
          secondaryPrice: '\$4.16 / month',
          saveLabel: 'SAVE 40%',
          isSelected: _selectedProductId == 'bloom.premium.yearly',
          onTap: () {
            HapticService.selection();
            setState(() => _selectedProductId = 'bloom.premium.yearly');
          },
        ),
        const SizedBox(height: 16),
        _PricingCard(
        ...
        _PricingCard(
          productId: 'bloom.premium.weekly',
          title: 'Weekly',
          priceDisplay: '\$2.99',
          intervalLabel: '/ week',
          secondaryPrice: 'Short-term',
          isSelected: _selectedProductId == 'bloom.premium.weekly',
          onTap: () {
            HapticService.selection();
            setState(() => _selectedProductId = 'bloom.premium.weekly');
          },
        ),
          ...
          child: ElevatedButton(
            onPressed: _isProcessing
                ...
                : () async {
                    ...
                    // Analytics
                    await BloomAnalytics.instance.logPurchaseAttempt(
        ...
        Row(
          ...
          children: [
            ...
            _FooterLink(
              label: 'Privacy',
              onTap: () => launchUrl(Uri.parse('https://bloom.app/privacy')),
            ),
          ],
        ),
        const SizedBox(height: 40),
