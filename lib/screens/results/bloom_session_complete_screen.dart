...
class BloomSessionCompleteScreen extends StatelessWidget {
  BloomSessionCompleteScreen({super.key}) : _copySet = _copySets[Random().nextInt(_copySets.length)];
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Expanded(
                child: Center(
                  child: Column(
                    ...
                    children: [
                      const SizedBox(
                        height: BloomResultsConstants.verticalSpacingLarge,
                      ),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(
                  vertical: BloomResultsConstants.verticalSpacingLarge,
                ),
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).pushAndRemoveUntil(
                          MaterialPageRoute(
                            builder: (context) => const BloomShellScreen(),
                          ),
                          (route) => false);
                    },
