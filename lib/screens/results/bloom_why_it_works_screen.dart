...
class BloomWhyItWorksScreen extends StatefulWidget {
  ...
  const BloomWhyItWorksScreen({
    super.key,
    this.practiceId = 'core_bloom',
    required this.onContinue,
  });

  @override
  State<BloomWhyItWorksScreen> createState() => _BloomWhyItWorksScreenState();
}

class _BloomWhyItWorksScreenState extends State<BloomWhyItWorksScreen> {
