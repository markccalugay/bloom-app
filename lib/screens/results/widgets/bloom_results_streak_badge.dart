...
class BloomResultsStreakBadge extends StatefulWidget {
  final int streak;
  ...
  @override
  State<BloomResultsStreakBadge> createState() =>
      _BloomResultsStreakBadgeState();
}

class _BloomResultsStreakBadgeState extends State<BloomResultsStreakBadge>
  ...
  void _startAnimation() {
    ...
    if (delay == Duration.zero) {
      ...
      SoundscapeService.instance.playSfx(BloomAssets.flameSfx);
      return;
    }
  ...
  @override
  void didUpdateWidget(covariant BloomResultsStreakBadge oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      width: BloomResultsConstants.streakBadgeSize,
      height: BloomResultsConstants.streakBadgeSize,
      child: Stack(
