...
class BloomResultsStreakRow extends StatelessWidget {
  final int streak;
...
class _SmallFlameState extends State<_SmallFlame> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Widget flame = SizedBox(
      width: BloomResultsConstants.smallFlameSize,
      height: BloomResultsConstants.smallFlameSize,
      child: showTeal
          ? ShaderMask(
